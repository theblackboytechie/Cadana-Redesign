...
@php
  ...
  $accountId = end($parts);
  $theowner_from_url = $parts[count($parts) - 2]; // Get second-to-last parameter
@endphp
    ...
    <form x-data="{ formStep: 1 }" class="flex items-start gap-8">
      ...
      >
        ...
        >
          ...
          <span
            class="@if($theowner_from_url == 'accountsverification') text-primary @else text-black-2 @endif group-hover:text-primary"
            >Verification</span
          >
        </a>
        ...
        >
          ...
          <span
            class="@if($theowner_from_url == 'medicalrecords') text-primary @else text-black-2 @endif group-hover:text-primary"
        ...
        >
          ...
          <span
            class="@if($theowner_from_url == 'donationrecords') text-primary @else text-black-2 @endif group-hover:text-primary"
      ...
      <div class="w-11/12 lg:w-8/12 ">
        ...
        @elseif($owner == "viewaccountsverification")
          <div>
            <div
              class="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark"
            >
        ...
        @elseif($owner == "viewvettedcredentials")
          <div>
            <div
              class="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark"
            >
        ...
        @elseif($owner == "viewupdatepassword")
          <div>
            <div
              class="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark"
            >
        ...
        @elseif($owner == "viewmedicalrecords")
          <div
        ...
        @elseif($owner == "viewdonationrecords")
          <!--  -->
          <div           
          ...
          >
            ...
            >
              ...
              <div class="gender_checker" thegender="{{$thegender}}"></div>
              @if($thegender == "male")
