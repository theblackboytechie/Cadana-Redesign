<div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
            <div class="w-full">
              ...
              <div class="flex items-start gap-6">
                <div
                  class="w-3/12 overflow-hidden rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark"
                >
                  <div class="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
                    <div
                      class="relative z-30 mx-auto h-30 w-full max-w-30 rounded-full bg-white/20 p-1 backdrop-blur sm:h-44 sm:max-w-44 sm:p-3"
                    >
                      <div class="relative drop-shadow-3">
                        <img src="{{ asset('storage/assets/images/user-01.png') }}" alt="profile" />
                      </div>
                    </div>
                    <div class="mt-4">
                      <h3
                ...
                <div class="flex w-9/12 flex-col gap-8">
                  <div
